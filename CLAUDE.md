...
## תזכורת חשובה
בכל תחילת שיחה — הזכר לטל: **עדיף לעבוד דרך גרסת הדסקטופ של Claude (המותקנת על המחשב) ולא דרך גרסת הדפדפן.**
...
- FormSubmit — DPA נחתם ע"י טל ב-28.8.26 ונשלח ל-Formspree, ממתין לחתימה נגדית מצדם
