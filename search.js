(function () {
  var INDEX = [
    ...
    { t: 'הטבה לפי סעיף 125ד\' לגימלאים', u: 'section-125d.html', d: 'פטור ממס רווחי הון על הכנסות מריבית וחיסכון לגמלאים', k: 'סעיף 125ד גימלאים פטור ממס רווחי הון ריבית חיסכון פרישה 15000 18360 מס הכנסה גיל פרישה' },
    ...
    { t: 'מחשבונים פיננסיים', u: 'calculators.html', d: 'ריבית דה ריבית, פרישה, פיצויים, הלוואה מול השקעה ועוד', k: 'מחשבון ריבית דה ריבית סימולטור פרישה פיצויי פיטורים הלוואה מול השקעה פנסיה מול ביטוח מנהלים דמי ניהול' },
    { t: 'מחשבון דמי ניהול פנסיה', u: 'pension-fees.html', d: 'השוואת דמי ניהול בקרן הפנסיה - מצבירה מול מהפקדות', k: 'דמי ניהול פנסיה השוואה קרן פנסיה מור מיטב כלל הפניקס' },
    { t: 'בדיקת תיק ביטוח', u: 'checkup.html', d: 'הגנה מלאה על הנכסים ועל איכות החיים שלך ושל משפחתך', k: 'צ\'ק אפ בדיקת תיק ביטוח ביקורת כיסויים פוליסה' },
    { t: 'קרנות גידור בנאמנות', u: 'hedge-funds.html', d: 'קרנות גידור בנאמנות - מדריך מקצועי', k: 'קרנות גידור בנאמנות hedge fund השקעה אלטרנטיבית' },
    { t: 'RSU, ESPP ואופציות', u: 'rsu-espp-options.html', d: 'מיסוי מניות לעובדי הייטק - סעיף 102, מס יסף, רילוקיישן', k: 'RSU ESPP אופציות מניות הייטק מיסוי סעיף 102 מס יסף רילוקיישן קיזוז הפסדים' },
    { t: 'מדריך אופטימיזציה לתכנון פיננסי', u: 'guide-financial-optimization.html', d: '7 צעדים לניהול עושר חכם ויעיל: מיפוי נכסים, ייעול דמי ניהול, תכנון מס', k: 'מדריך אופטימיזציה ניהול עושר מיפוי נכסים דמי ניהול תכנון מס' },
  ];
