...
(function () {
  ...
  function injectFooterInstallBanner() {
    ...
    card.style.cssText = 'max-width:900px;margin:4rem auto 3rem;background:rgba(201,168,76,.08);border:1.5px solid rgba(201,168,76,.5);border-radius:14px;padding:1.3rem 1.6rem;text-align:center;';
    card.innerHTML =
